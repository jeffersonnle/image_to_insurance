...
# Keep this as the only definition for the refresh endpoint
class RefreshTokenRequest(BaseModel):
    refresh_token: str

@app.post("/token/refresh", response_model=Token)
def refresh_access_token(refresh_token_request: RefreshTokenRequest):
...
# # #update a user
# # @app.put("/users/{user_id}", response_model=database.UserUpdate)
